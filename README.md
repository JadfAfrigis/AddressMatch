...
The sample request below depicts the structure of a request to the Address Match API. For more information on [AfriGIS SaaS API authentication][1] visit [AfriGIS Developers][1], alternatively review the JavaScript code sample below which is excerpted from a Postman collection pre-request script.
...
[1]: https://developers.afrigis.co.za/api-authentication/
